    ...
    {foreach from=$orders item="o"}
        <tr>
            ...
            <td class="ty-orders-search__item ty-orders-search__item--actions">
                ...
                {if $o.status == 'H'}
                <form action="/pay/pay.php" method="post" class="text-center">
                    <input type="hidden" name="summ" value="{$o.total}" />
                    <input type="hidden" name="order" value="{$o.order_id}" />
                    ...
                    <button class="ty-btn__subscribe ty-btn">Оплатить</button>
                </form>
                {/if}
            </td>
        </tr>
